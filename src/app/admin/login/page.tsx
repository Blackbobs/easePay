          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div>
              ...
              <div className="flex items-center gap-2 w-full border border-gray-300 rounded-full p-3 focus-within:ring-2 focus-within:ring-primary focus-within:border-primary transition">
                <Mail className="text-gray-500 group-focus-within:text-primary" />
                <input
                  id="email"
                  type="email"
            ...
            <div>
              ...
              <div className="flex items-center gap-2 w-full border border-gray-300 rounded-full p-3 focus-within:ring-2 focus-within:ring-primary focus-within:border-primary transition">
                <ShieldCheck className="text-gray-500 group-focus-within:text-primary" />
                <input
                  id="password"
                  type="password"
            ...
            <button
              type="submit"
              className="w-full bg-primary text-white py-3 rounded-full my-5 font-medium"
            >
              Sign In
            </button>
          </form>
